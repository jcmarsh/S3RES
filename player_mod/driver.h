...
/**
@brief Base class for drivers which provides redundancy

For now copied from ThreadedDriver above, and modified as needed.
*/
class PLAYERCORE_EXPORT RedundantDriver : public Driver
{
  protected:
